...
<asp:content runat="server" contentplaceholderid="ContentPlaceHolder1">
                            ...
                            <div class="form-horizontal col-sm-12">
                                ...
                                <div class="form-group m-b-0">
                                    <div class="col-sm-offset-2 col-sm-10">
                                        <a href="javascript:void(0);" class="btn btn-custom waves-effect waves-light" id="asell"><!--卖出YT--><%=GetLanguage("Sell") %>YT</a>
                                    </div>
                                </div>
                        	</div>
                        </div>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#asell").click(function () {
                $(this).attr("disabled", true); 
                var price = $("#txtprice").val();
                var num = $("#txtnum").val();
                var paytwd = $.md5($("#txtpaypwd").val());
                $.ajax({
                    url: "/AppService/Trading.ashx",
                    type: "post",
                    data: { act: "sell", userid: userid, price: price, number: num, paypassword: paytwd },
                    success: function (result) {
                        var data = eval('(' + result + ')');
