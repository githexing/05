    ...
    <div class="content">
        <div class="container">
            <div class="row">
			    <div class="col-sm-12">
					<div class="card-box">
                        <h4 class="header-title m-b-30"><!--卖出记录--><%=GetLanguage("SellRecords") %></h4>
                        <div class="row">
                            <div class="col-md-12">
	                                ...
	                                <table class="table table-condensed m-0">
	                                    <thead>
	                                        <tr>
	                                            ...
	                                            <th style="min-width: 80px;"><!--卖出数量--><%=GetLanguage("SellCount") %></th>
    ...
    <script type="text/javascript">
        ...
        function AjaxGetData(index, size) {
            ...
            $.ajax({
                ...
                type: "post",
                data: { act: "selllist", userid: userid, pageindex: index, pagesize: size, fromwhere: "pc" },
                    ...
                    if (data.state = "success") {
                        ...
                        if (length <= 0) {
                            ...
                            for (var i = 0; i < length; i++) {
                                htmlStr += "<tr>";
                                htmlStr += "<td th-name='创建时间'>" + list[i].SellDate + "</td>";
                                ...
                                htmlStr += "<td th-name='卖出总量'>" + list[i].Number + "</td>";
                                htmlStr += "<td th-name='已卖数量'>" + list[i].SaleNum + "</td>";
                                htmlStr += "<td th-name='剩余数量'>" + list[i].SurplusNum + "</td>";
